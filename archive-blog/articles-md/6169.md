---
post_id: 6169
title: "為 Firefox OS 打造 Firefox 瀏覽器 (下)"
date: "2014-08-29"
page_type: "post"
categories:
  - "Firefox"
...
tags: []
author: null
original_url: "https://blog.mozilla.com.tw/?p=6169"
archive_url: "https://web.archive.org/web/20190825004626/https://blog.mozilla.com.tw/posts/6169/building-the-firefox-browser-for-firefox-os-3"
wayback_timestamp: "20190825004626"
status: "ok"
asset_status: "skipped"
---

在看完了《[為 Firefox OS 打造 Firefox 瀏覽器 (上)](https://blog.mozilla.com.tw/posts/6155/)》和《[(中)](https://blog.mozilla.com.tw/posts/6166/)》之後，請跟著我們看完整個故事，也進一步了解 Firefox OS 的設計概念與未來走向。
...
![2013 年 7 月瀏覽器團隊於倫敦參加 Work Week](../assets/6169/wp-content/uploads/firefox-os-browser-browser_team-500.jpg)
...
![1.4 版本的瀏覽器 App](../assets/6169/wp-content/uploads/firefox-os-browser-v1.4.png)
1.4 版本的瀏覽器 App
...
一旦我們證明上述概念可行，也讓實際裝置上市之後，就該設法找出 Firefox OS 日後的產品區隔特色。我們不想只是模仿現有的東西，也要讓後續產品展現網路的專屬優勢並擁有 Mozilla 的基因；這除了是體驗網路的最佳方式之外，也是 [HTML5](https://developer.mozilla.org/en/html/html5) 得以活躍的平台。
...
![2011 年 12 月的早期系統泛用型智慧位址列模型](../assets/6169/wp-content/uploads/firefox-os-browser-b2g_awseomescreen.png)
...
![2013 年 3 月 Gordon 設計的 Rocketbar 原型](../assets/6169/wp-content/uploads/firefox-os-browser-rocketbar_prototype.png)
...
![2013 年 4 月於倫敦的腦力激盪活動](../assets/6169/wp-content/uploads/firefox-os-browser-ux_workshop-500.jpg)
...
![2013 年 6 月位於巴黎的 Haida 原型開發活動](../assets/6169/wp-content/uploads/firefox-os-browser-haida_team-500.jpg)
2013 年 6 月位於巴黎的 Haida 原型開發活動

![2013 年 6 月位於巴黎，Josh 與 Gordon 以近似的時尚衣著進行開發。](../assets/6169/wp-content/uploads/firefox-os-browser-josh_and_gordon-500.jpg)
2013 年 6 月位於巴黎，Josh 與 Gordon 以近似的時尚衣著進行開發。

![2013 年 6 月正於巴黎工作的魔法師](../assets/6169/wp-content/uploads/firefox-os-browser-haida_engineers-500.jpg)
...
![2014 年 7 月，Rocketbar 的 UI 模型分別處於展開與收攏狀態](../assets/6169/wp-content/uploads/firefox-os-browser-rocketbar.png)
2014 年 7 月，Rocketbar 的 UI 模型分別處於展開與收攏狀態

在此同時，我們也看到 Web 標準隨著 [manifests](https://w3c.github.io/manifest/)、[packages](https://w3ctag.github.io/packaging-on-the-web/)、[webviews](https://benfrancis.github.io/webview/) 而不斷進化。而最近則針對 [App 範圍](https://github.com/w3c/manifest/issues/114)的定義開始了一系列討論。
...
Firefox OS 開放源碼專案，是完全以[開放](https://github.com/mozilla-b2g/B2G)的方式開發而得。如果你也想對 Gaia 有所貢獻，請參閱 MDN 上的《[Developing Gaia](https://developer.mozilla.org/en-US/Firefox_OS/Developing_Gaia)》頁面。如果你想開發自己的 HTML5 App 並於 Firefox OS 執行，可參閱《[應用程式中心](https://developer.mozilla.org/zh-TW/Apps)》。
