...
tags: []
author: null
original_url: "https://blog.mozilla.com.tw/?p=6956"
archive_url: "https://web.archive.org/web/20190824004659/https://blog.mozilla.com.tw/posts/6956/porting-to-emscripten-1"
...
- [General overview of porting in Emscripten documentation](https://kripken.github.io/emscripten-site/docs/porting/index.html)

- [A porting experience using Unity WebGL](https://hacks.mozilla.org/2014/10/unity-games-in-webgl-owlchemy-labs-conversion-of-aaaaa-to-asm-js/)
...
在真正接觸 Emscripten 之前，須先調整你的開發環境。首先你要使用 SDL2。SDL 函式庫將處理特定平台的作業，如建立視窗或處理輸入。Emscripten 現已移植不完整的 SDL 1.3。但另有[完整的 SDL2](https://github.com/Daft-Freak/SDL-emscripten) 正移植中，且很快就會正式完成整合。

![FTL-combat](../assets/6956/wp-content/uploads/FTL-combat-1024x586.jpg)
...
若要概略了解 Windows 版遊戲移植成 Linux 版本的方法，可參閱 [Ryan Gordon 的《Steam Dev Days》](https://www.youtube.com/watch?v=Sd8ie5R4CVE)。

如果你在使用 Windows 環境，也可以透過 MinGW 進行編譯。

看到這裡，你對 Emscripten 是否有進一步的了解呢？請繼續了解《[運用 Emscripten 移植遊戲 (中)](https://blog.mozilla.com.tw/posts/6963/porting-to-emscripten-2)》所介紹好用的工具與第三方函式庫，請隨時注意我們分享的文章！
