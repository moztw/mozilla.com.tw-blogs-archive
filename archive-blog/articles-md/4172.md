---
post_id: 4172
title: "Songs of Diridum：Web Audio API 的極致"
date: "2013-11-12"
page_type: "post"
categories:
  - "Web App"
tags: []
author: null
original_url: "https://blog.mozilla.com.tw/?p=4172"
archive_url: "https://web.archive.org/web/20160623180428/https://blog.mozilla.com.tw/posts/4172/songs-of-diridum-pushing-the-web-audio-api-to-its-limits"
wayback_timestamp: "20160623180428"
status: "ok"
...
我們稱此展示為「[Songs of Diridum](https://www.gooengine.com/mozilla-web-audio-demo-built-in-goo-engine/)」。

![Songs-of-Diridum-5](../assets/4172/wp-content/uploads/Songs-of-Diridum-5-1024x558.jpg)
...
我們取名的「Songs of Diridum」，就是以「[LOD: Legend of Diridum](https://www.lodsaga.com/)」遊戲的圖像與設定為背景。而 LOD 團隊是由 Michael Stenmark 這位遊戲設計老手所帶領。

![Songs-of-Diridum-3](../assets/4172/wp-content/uploads/Songs-of-Diridum-3.jpg)
...
我們喜愛 Web 與 [HTML5](https://developer.mozilla.org/en/html/html5)。多款裝置的瀏覽器均可執行 HTML5，而且不需下載或安裝其他特殊的用戶端軟體。由於可在瀏覽器中直接執行遊戲，因此幾乎任何網站均可發佈遊戲；進而造就絕佳的商機與社交媒體整合方式。

我們想把 Songs of Diridum 設計成 HTML5 的瀏覽器遊戲，但又要如何達到 3D 效果呢？答案就是 [WebGL](https://developer.mozilla.org/en/WebGL)。WebGL 是 HTML5 的新標準，可讓遊戲如同原生 App 一樣存取硬體加速功能。HTML5 帶入 WebGL 又再次造成瀏覽器的大躍進，達到之前所沒有的圖像品質。WebGL 除了強化 HTML5 之外，遊戲期間也不需太高的頻寬。因為遊戲進行之前與進行期間，早已下載了相關遊戲要素 (即預先快取)，所以對網路連線速度的要求也不高。

但從頭建構 WebGL 遊戲是項大工程。由 Goo Technologies 所提供的 [Goo Platform](https://www.gooengine.com/) 則可簡化 WebGL 遊戲與應用程式的建構過程。另將於 11 月發表更簡單易用的 Goo Create。
...
![Songs-of-Diridum-2](../assets/4172/wp-content/uploads/Songs-of-Diridum-2-1024x558.jpg)
...
![Songs-of-Diridum-1](../assets/4172/wp-content/uploads/Songs-of-Diridum-1.png)
...
![Songs-of-Diridum-6](../assets/4172/wp-content/uploads/Songs-of-Diridum-6-1024x558.jpg)
...
現在就[來玩「Songs of Diridum」](https://www.gooengine.com/mozilla-web-audio-demo-built-in-goo-engine/)吧！

![Songs-of-Diridum-4](../assets/4172/wp-content/uploads/Songs-of-Diridum-4-1024x558.jpg)

原文連結：[Songs of Diridum: Pushing the Web Audio API to Its Limits](https://hacks.mozilla.org/2013/10/songs-of-diridum-pushing-the-web-audio-api-to-its-limits/)
