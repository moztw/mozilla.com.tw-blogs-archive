...
tags: []
author: null
original_url: "https://blog.mozilla.com.tw/?p=6532"
archive_url: "https://web.archive.org/web/20150923120827/https://blog.mozilla.com.tw/posts/6532/openh264-now-in-firefox"
wayback_timestamp: "20150923120827"
status: "ok"
...
現行的折衷辦法，是思科同意由其發佈免費的 H.264 編碼器外掛程式 ─「OpenH264」。思科將 OpenH264 的開放源碼放上 [Github](https://github.com/cisco/openh264)，並由 Mozilla 與思科合作出一套程序，驗證該OpenH264 確實來自於公開的原始碼，進而確保系統的透明度與可信賴性。

![openh264](../assets/6532/wp-content/uploads/openh264-1024x111.jpg)
...
我們會持續開發完全開放的編碼，用以取代 H.264 (可參考 [Daala](https://xiph.org/daala/))。目前 OpenH264 可讓連網的應用程式使用 H.264 而不需支付權利金，因此仍可說是 Open Web的重要進展。就意義上來說，OpenH264 雖非真正的開放，但至少是現有最開放且廣泛應用的影片編碼。
...
原文連結：[OpenH264 Now in Firefox](https://andreasgal.com/2014/10/14/openh264-now-in-firefox/)
