...
archive_url: "https://web.archive.org/web/20140608072002id_/http://tech.mozilla.com.tw/posts/4188/%e4%bd%bf%e7%94%a8%e4%b8%8d%e5%90%8c%e7%9a%84%e6%aa%94%e6%a1%88%e7%b3%bb%e7%b5%b1%ef%bc%8cb2g%e4%b8%bb%e7%a8%8b%e5%bc%8f%e6%b2%92%e8%b7%91%e8%b5%b7%e4%be%86%ef%bc%81"
wayback_timestamp: "20140608072002"
status: "ok"
...
[![based_on_mozilla_tech](https://tech.mozilla.com.tw/wp-content/uploads/2014/04/2010-01-27-19-10-54.png)](https://tech.mozilla.com.tw/wp-content/uploads/2014/04/2010-01-27-19-10-54.png)

雖然重新開機後也可以跑起來了，但每次 flash system.img 後，檔案屬性就會跑掉，那還真不方便。這時我突然想到曾經看到過一個 [patch](https://github.com/mozilla-b2g/gonk-misc/blob/master/init.rc.patch), 但在每次開機時 init.rc 都需要去修改檔案屬性好像也不是一個好方法。那就來弄清楚問題出在那裡吧！
...
這也太巧合了吧，我 porting 的這隻手機使用的是 ubifs，都沒有使用前面提到的這兩個 tools。相較於 yaffs2，ubifs 支持壓縮及還有一些其他優點，通常在 nand flash 容量較少的手機上就有可能使會用 ubifs。當然 ubifs 也不是完全沒有缺點，如果想要了解 nand flash 上不同檔案系統的特性可以參考這份 [測試報告](https://elinux.org/images/9/9a/CELFJamboree29-FlashFS-Toshiba.pdf)。
