...
archive_url: "https://web.archive.org/web/20150326142554id_/https://tech.mozilla.com.tw/?p=4188"
wayback_timestamp: "20150326142554"
status: "ok"
...
這也太巧合了吧，我 porting 的這隻手機使用的是 ubifs，都沒有使用前面提到的這兩個 tools。相較於 yaffs2，ubifs 支持壓縮, wear-leveling across whole MTD device及還有一些其他優點，通常在使用 nand flash 的手機上就有可能使會用 ubifs。當然 ubifs 也不是完全沒有缺點，如果想要了解 nand flash 上不同檔案系統的特性可以參考這份[介紹](https://www.linux-mtd.infradead.org/doc/ubi.ppt) 及 [測試報告](https://elinux.org/images/9/9a/CELFJamboree29-FlashFS-Toshiba.pdf)。
